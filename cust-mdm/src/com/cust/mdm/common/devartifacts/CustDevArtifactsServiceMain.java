 ...
 */
package com.cust.mdm.common.devartifacts;

import com.cust.mdm.common.module.*;
 ...
 */
@Deprecated
public class CustDevArtifactsServiceMain extends DevArtifactsServiceMain
{
	/**
	...
	{
		String module = "/" + CustModuleRegistrationListener.MODULE_NAME;
	...
	{
		DevArtifactsServiceMain.doMain(args, new CustDevArtifactsServiceMain());
	}
}
